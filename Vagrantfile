...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    vb.name = "vagrant-hardened-lab"
    vb.memory = "2048"
    vb.cpus = 2
  end
  
  # Cloud-Init provisioning
  # All OS-level configuration is delegated to cloud-init/user-data
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo "instance-id: vagrant-lab-001" > /var/lib/cloud/seed/nocloud-net/meta-data
